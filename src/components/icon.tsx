...
export default function Icon(props: Readonly<IconProps>) {
  return (
    <span className={`icon-container ${props.containerClassName ?? ""}`} data-nosnippet aria-hidden>
      <i translate="no" className={`icon mdi ${props.className ?? ""}`} style={props.style} title={props.title}>
        {props.icon}
      </i>
    </span>
  );
