    ...
    <footer className={"footer vertical-list justify-content-center"}>
      <div className={"vertical-list justify-content-center gap-4mm"}>
        ...
        <div className="horizontal-list gap-4mm normal title justify-content-center">
          <a href={t("footer.link_code_of_conduct")} target="_blank" rel="noopener noreferrer">
            {t("footer.code_of_conduct")}
          </a>
          <a href="https://furizon.net/join-furizon-staff/" target="_blank" rel="noopener noreferrer">
            {t("footer.volunteers")}
          </a>
          <a href="https://furizon.net/contact/" target="_blank" rel="noopener noreferrer">
            {t("footer.contact_us")}
          </a>
        </div>
        <div className="horizontal-list gap-4mm normal title justify-content-center">
          ...
          <a href="https://t.me/APSFurizon" target="_blank" rel="noopener noreferrer">
            <Image
              className="footer-logo-telegram"
