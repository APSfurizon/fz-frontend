...
export default function Footer() {
  ...
  return (
    <footer className={"footer vertical-list justify-content-center"}>
      <div className={"vertical-list justify-content-center gap-4mm"}>
        ...
        <div className="horizontal-list gap-4mm normal title justify-content-center">
          <a href={t("footer.link_code_of_conduct")}
            target="_blank"
            rel="noopener noreferrer">
            {t('footer.code_of_conduct')}
          </a>
          <a href="https://furizon.net/join-furizon-staff/"
            target="_blank"
            rel="noopener noreferrer">
            {t('footer.volunteers')}
          </a>
          <a href="https://furizon.net/contact/"
            target="_blank"
            rel="noopener noreferrer">
            {t('footer.contact_us')}
          </a>
        ...
        <div className="horizontal-list gap-4mm normal title justify-content-center">
          <a href="https://www.youtube.com/@apsfurizon7425" target="_blank" rel="noopener noreferrer">
            <Image className="footer-logo-youtube"
              src="/images/footer/youtube-brands-solid.svg"
              alt="Youtube logo"
              width={32}
              height={32} />
          </a>
          <a href="https://www.instagram.com/furizonaps/" target="_blank" rel="noopener noreferrer">
            <Image className="footer-logo-instagram"
              src="/images/footer/instagram-brands-solid.svg"
              alt="Instagram logo"
              width={32}
              height={32} />
          </a>
          <a href="https://t.me/APSFurizon"
            target="_blank"
            rel="noopener noreferrer">
            <Image className="footer-logo-telegram"
              src="/images/footer/telegram-brands-solid.svg"
              alt="Facebook logo"
              width={32}
              height={32} />
          </a>
          <a href="https://x.com/FurizonEvents"
            target="_blank"
            rel="noopener noreferrer">
            <Image className="footer-logo-twitter"
              src="/images/footer/square-x-twitter-brands-solid.svg"
              alt="Twitter logo"
              width={32}
              height={32} />
          </a>
          <a href="https://www.facebook.com/Furizon/"
            target="_blank"
            rel="noopener noreferrer">
            <Image className="footer-logo-facebook"
              src="/images/footer/facebook-brands-solid.svg"
              alt="Facebook logo"
              width={32}
              height={32} />
          </a>
