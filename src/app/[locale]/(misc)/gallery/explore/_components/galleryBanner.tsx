...
export default function GalleryBanner() {
    ...
    return currentFilterData && <>
        {currentFilterData.event && <div className="gallery-banner__event rounded-l">
            <img className="gallery-banner__event__image"
            ...
            <div className="gallery-banner__event__overlay">
                <div className="vertical-list gallery-banner__event__name">
                    <span className="title x-large">
                        {translate(currentFilterData.event.event.eventNames, locale)}
                    </span>
