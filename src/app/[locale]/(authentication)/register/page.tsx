    ...
    <>
      ...
      >
        ...
        <FpInput
          ...
          label={t("register.form.nickname.label")}
        ...
        <FpInput
          ...
          required
          inputType="email"
          label={t("register.form.confirm_email.label")}
        ...
        <NoticeBox theme={NoticeTheme.FAQ} title={t("register.question.description_title")} className="descriptive">
          {t("register.question.description")}
        </NoticeBox>
        <Checkbox fieldName="tosAccepted">
          {t.rich("register.form.disclaimer_tos.label", {
            terms: (chunks) => (
              <Link target="_blank" href={t("register.form.disclaimer_tos.link")} className="highlight underlined">
                {chunks}
              </Link>
            ),
          })}
        </Checkbox>
        <Checkbox fieldName="privacyAccepted">{t("register.form.disclaimer_data_protection.label")}</Checkbox>
