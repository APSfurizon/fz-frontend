...
export default function Register() {
  ...
  return <>
    ...
    <DataForm className="vertical-list login-form" loading={loading} setLoading={setLoading} action={new LoginFormAction} onSuccess={manageSuccess} onFail={(err) => manageError(err)} saveButton={{iconName: ICONS.KEY, text: t("register.register")}} hideSave={page != 1}>
      ...
      <div className={`page flex-align-center ${page == 1 ? "": "hidden"}`}>
        ...
        <div className="form-pair horizontal-list gap-4mm">
          ...
          <AutoInput fieldName="birthCountry" required={true} noDelay={true} type={AutoInputType.COUNTRIES} label={t("register.phase_2.label_birth_country")} placeholder={t("register.phase_2.placeholder_birth_country")}/>
        </div>
        ...
        <div className="form-pair horizontal-list gap-4mm">
          <AutoInput fieldName="birthRegion" required={true} noDelay={true} type={AutoInputType.COUNTRIES} label={t("register.phase_2.label_birth_region")} placeholder={t("register.phase_2.placeholder_birth_region")}/>
        ...
        <div className="form-pair horizontal-list gap-4mm">
          <AutoInput fieldName="residenceCountry" required={true} noDelay={true} type={AutoInputType.COUNTRIES} label={t("register.phase_2.label_residence_country")} placeholder={t("register.phase_2.placeholder_residence_country")}/>
          <AutoInput fieldName="residenceRegion" required={true} noDelay={true} type={AutoInputType.COUNTRIES} label={t("register.phase_2.label_residence_region")} placeholder={t("register.phase_2.placeholder_residence_region")}/>
        </div>
        <div className="form-pair horizontal-list gap-4mm">
