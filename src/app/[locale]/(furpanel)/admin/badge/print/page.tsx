...
export default function AdvancedBadgePrint() {
  ...
  const canPrint: boolean = useMemo(
    () => (regularBadgeRows && regularBadgeRows.length > 0) || (fursuitBadgeRows && fursuitBadgeRows.length > 0),
    [regularBadgeRows, fursuitBadgeRows]
  );
