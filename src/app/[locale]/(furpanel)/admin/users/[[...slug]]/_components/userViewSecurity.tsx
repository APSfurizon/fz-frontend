    ...
    <>
      <div className="vertical-list gap-2mm rounded-m" style={{ padding: "0.625em" }}>
        ...
        <div className="horizontal-list gap-2mm">
          {!userData.banned && (
            <FpButton icon="ACCOUNT_CIRCLE_OFF" onClick={promptBan} disabled={isSelf}>
              {t("furpanel.admin.users.accounts.view.actions.ban")}
            </FpButton>
          )}
          {userData.banned && (
            <FpButton icon="ACCOUNT_CIRCLE" onClick={promptUnban} disabled={isSelf}>
              {t("furpanel.admin.users.accounts.view.actions.unban")}
            </FpButton>
          )}
          <FpButton icon="MAIL" onClick={() => setChangeEmailModalOpen(true)}>
            {t("furpanel.admin.users.accounts.view.actions.change_email")}
          </FpButton>
          <FpButton icon="KEY" onClick={() => setChangePasswordModalOpen(true)}>
      ...
      >
        ...
        <div className="bottom-toolbar">
          ...
          <FpButton
            title={t("furpanel.admin.users.accounts.view.actions.ban")}
            onClick={() => ban()}
      ...
      >
        ...
        <div className="bottom-toolbar">
          ...
          <div className="spacer"></div>
          <FpButton
            title={t("furpanel.admin.users.accounts.view.actions.unban")}
            onClick={() => unban()}
            icon="ACCOUNT_CIRCLE"
            busy={loading}
          >
      ...
      >
        <DataForm
          action={new ChangeEmailFormAction()}
          hideSave
          className="gap-2mm"
