...
export default function LinkOrderModal() {
  ...
  return (
    <>
      ...
      >
        <p>
          {t.rich("furpanel.admin.users.accounts.view.orders_table.actions.link_order.description", {
        ...
        >
          ...
          <div className="horizontal-list gap-4mm margin-top-2mm">
            <FpButton type="button" className="danger" icon="CANCEL" onClick={() => setLinkModalOpen(false)}>
              {t("common.cancel")}
            </FpButton>
