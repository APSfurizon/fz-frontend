...
export default function UserViewPersonalInfo({
  ...
  const hasAdminPermission = useMemo(
    () => (userDisplay?.permissions || []).includes(Permissions.CAN_MANAGE_USER_PUBLIC_INFO) ?? false,
    [userDisplay]
  );
  ...
  return (
    <>
      <DataForm
        className="user-view-personal-info rounded-m vertical-list gap-2mm"
        action={hasAdminPermission ? new UpdatePersonalInfoAdminFormAction() : new UpdatePersonalInfoFormAction()}
      ...
      >
        ...
        <div className="form-pair horizontal-list gap-4mm">
          ...
          <FpInput
            ...
            style={{ flex: "2" }}
            initialValue={personalInformation?.phoneNumber}
            prefix={phonePrefix}
          />
        </div>
        <div className="form-pair horizontal-list gap-4mm">
          ...
          <FpInput
            ...
            initialValue={personalInformation?.telegramUsername}
          />
          <FpSelect
            fieldName="shirtSize"
            required
