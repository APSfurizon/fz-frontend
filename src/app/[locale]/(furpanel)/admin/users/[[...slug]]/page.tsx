...
export default function AdminUsersPage({ params }: { params: Promise<{ slug: string[] }> }) {
  ...
  const onSearchCriteriaChange = useMemo(
    () =>
    ...
    >
      <div className="stretch-page">
        <div className="horizontal-list align-items-center gap-4mm flex-wrap">
          <Link href={getParentDirectory(path, userId ? 2 : 1)}>
          ...
          <>
            ...
            <div className="user-data-grid">
              <div className="user-personal-data">
                ...
                <UserViewPersonalInfo personalInformation={userData.personalInfo} reloadData={reloadData} />
              </div>
