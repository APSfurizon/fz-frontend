...
import { FursuitBadge, RegularBadge, SearchFursuitBadgesApiAction, SearchFursuitBadgesResponse, SearchRegularBadgesApiAction, SearchRegularBadgesResponse } from "@/lib/api/admin/advancedPrint";
...
export default function AdvancedBadgePrint() {
    ...
    const regularColumns: ColumnDef<RegularBadge, any>[] = useMemo(()=>[
    ...
    const fursuitColumns: ColumnDef<FursuitBadge, any>[] = useMemo(()=>[
    ...
    return <div className="page">
        ...
        <div className="vertical-list gap-2mm">
            {/* Regular badges */}
            <BadgeTable<RegularBadge, SearchRegularBadgesResponse> title={t("furpanel.admin.events.badges.print.advanced_mode.regular.title")}
            ...
            {/* Fursuit badges */}
            <BadgeTable<FursuitBadge, SearchFursuitBadgesResponse> title={t("furpanel.admin.events.badges.print.advanced_mode.fursuit.title")}
