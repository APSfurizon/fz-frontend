...
const defaultScheduleActivityDetailResolver: ScheduleActivityDetailResolver = async (activityId, context) => {
...
let scheduleActivityDetailResolver: ScheduleActivityDetailResolver = defaultScheduleActivityDetailResolver;

export function setScheduleActivityDetailResolver(resolver: ScheduleActivityDetailResolver | null): void {
